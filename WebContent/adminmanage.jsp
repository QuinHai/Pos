...
<% 
	...
	if(alevel==null){
		...
		alevel = new String(alevel.getBytes(),"UTF-8");
		if(alevel.equals("普通")){
...
<table width="100%" height="44" bgcolor="#206AB3">
	  ...
	  <tr>
		...
		<table height="42" style="background:url(img/admin_sear.jpg) no-repeat">
		  <tr>
		    ...
		    <td>
		     <input name="key" id="key" value="请输入要搜索的关键字" style="border:0; width:210px"
	...
	<table width="100%" border="0" cellspacing="1" bgcolor="black">
	 ...
	 %>
	 	<td><%= new String(ai.getAname().getBytes(),"UTF-8") %></td>
	 	<td><%= new String(ai.getAlevel().getBytes(),"UTF-8") %></td>
