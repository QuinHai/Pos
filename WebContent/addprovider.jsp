	...
	<hr color="black" size="1" width="100%"/>
 	...
 	<table width="80%" border="0" cellspacing="1" bgcolor="black" align="center">
	  ...
	  <tr bgcolor="white">
		...
		<td><input size="20" name="plinkman" id="plinkman"/></td>
	  </tr>
	  <tr bgcolor="white">
	    <td align="center">公司地址:</td>
		<td><input size="20" name="paddress" id="paddress"/></td>
	  </tr>
	  <tr bgcolor="white">
	    <td align="center">公司电话:</td>
		<td><input size="20" name="ptel" id="ptel"/></td>
	  </tr>
	  <tr bgcolor="white">
	    <td align="center">E-mail:</td>
		<td><input size="20" name="pemail" id="pemail"/></td>
	  </tr>
	  <tr bgcolor="white">
	    <td align="center">备&nbsp;&nbsp;&nbsp;&nbsp;注:</td>
		<td><input size="20" name="premark" id="premark"/></td>
	  </tr>
	</table>
